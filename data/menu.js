...
const CATEGORIES = [
  ...
  {
    "id": "limonatalar-1788262279067",
    "name": "Çocuk İçecekleri",
    "icon": "🤖",
    "active": true
  }
];
...
function loadMenuData() {
  ...
  return { categories: CATEGORIES, products: PRODUCTS, cafeInfo: CAFE_INFO };
}
...
function initMenuData() {
  if (!localStorage.getItem("cafeMenuData")) {
    saveMenuData({ categories: CATEGORIES, products: PRODUCTS, cafeInfo: CAFE_INFO });
  }
}